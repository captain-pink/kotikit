...
export function registerDesignReviewTools(
      ...
      try {
        ...
        const session = store.recordDesignAuditSession({
          ...
          brief: {
            ...
            ...(input.primaryUserGoal !== undefined
              ? { primaryUserGoal: input.primaryUserGoal }
              : {}),
  ...
  registerTool(
    registry,
    {
      ...
      description:
        "Return a compact standalone design review report with findings and pending comment outbox rows.",
      inputSchema: {
        type: "object",
        properties: {
          sessionId: { type: "string" },
  ...
  registerTool(
    registry,
    {
      ...
      description:
        "Prepare pending root Figma comments for commentable design review findings without posting them.",
      inputSchema: {
        type: "object",
        properties: {
          sessionId: { type: "string" },
  ...
  registerTool(
    registry,
    {
      ...
      description:
        "Post prepared design review comments to Figma. Requires explicit confirm: true and file_comments:write.",
      inputSchema: {
        type: "object",
        properties: {
          sessionId: { type: "string" },
          ...
          confirm: {
            type: "boolean",
            description: "Must be true after the user approves posting comments.",
          },
        },
        required: ["confirm"],
      },
