  ...
  "kotikit.create_figma_draft": {
    ...
    render: (args) =>
      [
        ...
        "Apply one screen state, region state, or approved post-screen draft component with use_figma at the canvas plan bounds.",
        ...
        "For draft component transactions, record figmaNodeKind as COMPONENT and record the real Figma component key.",
