...
- Before creating or refining a Figma design, ask for the exact target draft page URL and bind it through kotikit_bind_figma_target with pageUrl on the active run. Do not reverse-engineer target JSON from old runs. The page name must contain Draft or Drafts, and generated nodes stay inside the kotikit-owned Section for that screen.
