...
const ComponentPropertyDefSchema = z
  .object({
...
const FigmaComponentsResponseSchema = z
  .object({
    meta: z.object({
...
const FigmaComponentSetsResponseSchema = z
  .object({
    meta: z.object({
...
const FigmaStylesResponseSchema = z
  .object({
    meta: z.object({
...
const FigmaVariablesResponseSchema = z
  .object({
...
const FigmaNodesResponseSchema = z
  .object({
