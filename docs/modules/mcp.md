...
See [docs/tools.md](../tools.md) for the complete cheat-sheet. The 27 tools are grouped here by phase:
...
- Phase 5: `kotikit_plan_design`, `kotikit_design_get_screen`, `kotikit_design_apply_step`, `kotikit_design_review_comments`
...
- `docs/tools.md` — complete cheat-sheet for all 27 MCP tools
